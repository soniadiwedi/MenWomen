...
const SingleProductPage = () => {
  ...
  const handleAddToWishlist = async () => {
    ...
    await axios
      .post(`https://myntra-clone-ag3u.onrender.com/WishList/`, singleProduct)
      .then((res) => toast.success("Added to Wishlist Successfully....", {
  ...
  const AddtoBag = async () => {
    // console.log("newItem:",props)
    await axios
      .post(`https://myntra-clone-ag3u.onrender.com/cart/`, singleProduct)
      .then((res) => {
      ...
      .catch((err) =>
      toast.error("Already Exists in Your Bag", {
        position: toast.POSITION.TOP_LEFT
      })
      );
  };
