...
import {
    getKidsFilteredProducts,
    getKidsMainData,
    getKidsProducts,
    getKidsProductsSorted,
...
import PageNotFound from "./PageNotFound copy";
import Pagination from "../Components/Pagination copy";
...
const KidsProduct = () => {
    ...
    useEffect(() => {
        //console.log(sValue);
        dispatch(getKidsProductsSorted(sValue, currentPage));
    ...
    useEffect(() => {
        dispatch(getKidsFilteredProducts(brand));
    }, [brand, dispatch]);
